...
function sendRequest() {
    ...
    aiResponseDiv === null || aiResponseDiv === void 0 ? void 0 : aiResponseDiv.classList.remove("block");
    ...
    fetch("/send-question", {
        ...
        aiResponseDiv === null || aiResponseDiv === void 0 ? void 0 : aiResponseDiv.classList.remove("hidden");
        aiResponseDiv === null || aiResponseDiv === void 0 ? void 0 : aiResponseDiv.classList.add("block");
    })
        .catch(error => {
